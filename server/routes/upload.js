...
router.post("/", upload.single("file"), handleMulterError, async (req, res) => {
  try {
    ...
    let uploadOptions = {
      folder: "my-linkedin/posts",
    };

    // Determine resource type and folder based on file type
    if (req.file.mimetype.startsWith("image/")) {
      uploadOptions.resource_type = "image";
      uploadOptions.folder = "my-linkedin/post-images";
      ...
      uploadOptions.folder = "my-linkedin/post-videos";
      uploadOptions.transformation = [
      ...
      uploadOptions.folder = "my-linkedin/post-documents";
    }
      ...
      const result = await new Promise((resolve, reject) => {
        cloudinary.uploader
          .upload_stream(
            {
              resource_type: "image",
              folder: "my-linkedin/profile-pictures",
              transformation: [
